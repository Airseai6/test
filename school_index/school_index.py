    ...
    with open('new_list.txt', 'a')as f:
        for school in school_list:
            content = '### CloudLearn ' + school['u_name'] + school['a_name'] + '\n\n' \
                      ...
                      + '    ' + str(school['Nginx HTTP']) + ' Nginx HTTP\n' \
                      + '    ' + str(school['Python']) + ' Python\n' \
                      + '    ' + str(school['MySQL']) + ' MySQL\n' \
                      + '    ' + str(school['Redis']) + ' Redis\n' \
                      + '    ' + str(school['WebSocket']) + ' WebSocket\n' \
                      + '    ' + str(school['HTML']) + ' HTML\n' \
                      + '    ' + str(school['DB']) + ' DB\n' \
                      + '\n\n'
            f.write(content)
